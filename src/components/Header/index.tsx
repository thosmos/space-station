    ...
    <div className="header">
      <div className="logo-container">
        ...
        <div className="logo-title-container">
          spacestation now supports&nbsp;<span className="logo-title-gravity-bridge">Gravity Bridge Chain Fees</span>&nbsp;and&nbsp;<span className="logo-title-gravity-bridge">Canto Transfers</span>
        </div>
      </div>
    </div>
  );
